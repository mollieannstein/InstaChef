...
Procedure.update(115, :gif_url => "http://imgur.com/wL5wGGc")
Procedure.update(105, :gif_url => "http://imgur.com/B2aT1hp")
Procedure.update(106, :gif_url => "http://imgur.com/b1TxUMj")
Procedure.update(61, :gif_url => "http://imgur.com/i2r7jBb")
Procedure.update(34, :gif_url => "http://imgur.com/3CbTksh")
Procedure.update(11, :gif_url => "http://imgur.com/8s1rgeB")
Procedure.update(33, :gif_url => "http://imgur.com/h2cNhES")
Procedure.update(83, :gif_url => "http://imgur.com/G7O9A2B")
Procedure.update(57 , :gif_url => "http://imgur.com/yi55ALh")
Procedure.update(58, :gif_url => "http://imgur.com/n2e8AD0")
Procedure.update(23, :gif_url => "http://imgur.com/usMMzPP")
Procedure.update(20, :gif_url => "http://imgur.com/uZAWoVS")
Procedure.update(12, :gif_url => "http://imgur.com/yht3cKp")
