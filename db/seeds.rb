...
# yummly_rId_array_short = ["Chicken-And-Dumplings-I-Allrecipes", "Salsa-Allrecipes", "Horseradish-Sauce-Allrecipes_1", "Snow-Peak-Frosting-Allrecipes", "Classic-Candied-Sweet-Potatoes-Allrecipes", "Butterscotch-Drops-Allrecipes", "Tropical-Grilled-Chicken-Breast-AllRecipes-39303", "Bannock-Allrecipes", "Good-Old-Fashioned-Pancakes-546169", "Best-Spanish-Rice-Allrecipes"]

yummly_rId_array = ["Chicken-And-Dumplings-I-Allrecipes", "Salsa-Allrecipes", "Horseradish-Sauce-Allrecipes_1", "Snow-Peak-Frosting-Allrecipes", "Classic-Candied-Sweet-Potatoes-Allrecipes", "Butterscotch-Drops-Allrecipes", "Tropical-Grilled-Chicken-Breast-AllRecipes-39303", "Bannock-Allrecipes", "Good-Old-Fashioned-Pancakes-546169", "Best-Spanish-Rice-Allrecipes", "Creamy-Cheese-Bread-Allrecipes", "Traditional-White-Bread-Allrecipes", "London-Broil-For-The-Slow-Cooker-Allrecipes", "Slow-Cooker-Pulled-Pork-AllRecipes", "Best-Ever-Onion-Rings-Allrecipes", "Jen_s-Heavenly-Egg-Salad-Allrecipes", "Applesauce-Allrecipes_1", "Cabbage-Burgers-Allrecipes", "Easy-Hummus-Allrecipes", "Buffalo-Chicken-Dip-Allrecipes", "Easy-Gravy-Allrecipes", "Light-And-Fluffy-Spinach-Quiche-Allrecipes", "Best-Green-Bean-Casserole-Allrecipes", "Grandmother_s-Old-Fashioned-Butter-Roll-Allrecipes", "Valentino_s-Pizza-Crust-Allrecipes", "Brandied-Candied-Sweet-Potatoes-AllRecipes", "Pork-Tenderloin-Marinade-Allrecipes", "Chewy-Sugar-Cookies-Allrecipes", "Slow-Cooker-Roast-Beef-AllRecipes", "Grandma_s-Famous-Salmon-Cakes-Allrecipes", "Beef-Burgundy-Iii-Allrecipes", "The-Best-Mashed-Potatoes-Allrecipes", "Amazing-Pork-Tenderloin-In-The-Slow-Cooker-Allrecipes", "Swiss-Cheese-Meatloaf-Allrecipes", "Quick-And-Easy-Alfredo-Sauce-Allrecipes", "Dominican-Style-Oatmeal-AllRecipes", "The-World_s-Best-Turkey-Allrecipes", "Spicy-Honey-Mustard-Pork-Roast-Allrecipes", "Bacon-Wrapped-Stuffed-Mushrooms-Allrecipes", "Homefried-Potatoes-With-Garlic-And-Bacon-Allrecipes", "Roasted-New-Red-Potatoes-Allrecipes", "Fudge-Allrecipes", "Cream-Peas-Allrecipes", "Super-Easy-Chicken-Noodle-Soup-Allrecipes", "Pork-Tenderloin-In-Bourbon-Allrecipes", "Easiest-Brown-Gravy-Ever-Allrecipes", "Creamy-Chicken-Allrecipes", "Roasted-Pork-Loin-Allrecipes","Southern-Collard-Greens-Allrecipes", "Apricot-Chicken-Ii-Allrecipes", "White-Cream-Sauce-Allrecipes", "Gourmet-Chicken-Salad-Allrecipes", "Coffee-Butter-Frosting-Allrecipes"]
...
Procedure.update(115, :gif_url => "http://i.imgur.com/wL5wGGc.gif")
Procedure.update(105, :gif_url => "http://i.imgur.com/B2aT1hp.gif")
Procedure.update(106, :gif_url => "http://i.imgur.com/b1TxUMj.gif")
Procedure.update(61, :gif_url => "http://i.imgur.com/i2r7jBb.gif")
Procedure.update(34, :gif_url => "http://i.imgur.com/3CbTksh.gif")
Procedure.update(11, :gif_url => "http://i.imgur.com/8s1rgeB.gif")
Procedure.update(33, :gif_url => "http://i.imgur.com/h2cNhES.gif")
Procedure.update(83, :gif_url => "http://i.imgur.com/G7O9A2B.gif")
Procedure.update(57 , :gif_url => "http://i.imgur.com/yi55ALh.gif")
Procedure.update(58, :gif_url => "http://i.imgur.com/n2e8AD0.gif")
Procedure.update(23, :gif_url => "http://i.imgur.com/usMMzPP.gif")
Procedure.update(20, :gif_url => "http://i.imgur.com/uZAWoVS.gif")
Procedure.update(124, :gif_url => "http://i.imgur.com/yht3cKp.gif")
Procedure.update(69, :gif_url => "http://i.imgur.com/Aiiflyg.gif")
Procedure.update(73, :gif_url => "http://i.imgur.com/48WSvL9.gif")
Procedure.update()
