...
# uri = URI.parse(URI.escape("http://food2fork.com/api/get?key=df72a9ed98fb2f57b87e75ea295b0d69&rId=#{rId}"))
#
# response = Net::HTTP.get(uri)
# response = JSON.parse(response)
#
# ingredients = response["recipe"]["ingredients"]
# image_url = response["recipe"]["image_url"]
...
# doc = Nokogiri::HTML(open("http://allrecipes.com/recipe/143069/super-delicious-zuppa-toscana/"))
# doc.css('li.step span.recipe-directions__list--item').each do |step|
#   p step.text
# end
#
# p doc.css('div.subtext').first.text
